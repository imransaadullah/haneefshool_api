            ...
            ->setQuery(
                (new TableManipulator('hajRegistration'))
                    ...
                    ->addFields([
                        ...
                        (new FieldDefinition("lastName"))->varchar()->length(50)->notNull()->comment("student's Surname"),
                        (new FieldDefinition("dateOfBirth"))->varchar()->length(15)->notNull()->comment("Student's Date of Birth"),
                        (new FieldDefinition("gender"))->varchar()->length(15)->notNull()->comment("student's gender"),
                        ...
                        (new FieldDefinition("allergies"))->text()->length(5000)->notNull()->default('')->comment("allergies"),
                        ...
                        (new FieldDefinition("doctorPhoneNumber"))->varchar()->length(15)->comment("doctor's phone number"),
                    ])
                    ->getCreateTableStatement()
            )->execute();
    }
